...
const AWS_S3_ACCESS_KEY = process.env.hasOwnProperty('AWS_S3_ACCESS_KEY') ? process.env.AWS_S3_ACCESS_KEY : 'AKIAUYOVXJEVINOOQQ4D';
const AWS_S3_SECRET_ACCESS_KEY = process.env.hasOwnProperty('AWS_S3_SECRET_ACCESS_KEY') ? process.env.AWS_S3_SECRET_ACCESS_KEY : 'hS0H69GU0EC4WyAJ6cg1faUr7u13vzAWLs4bjKiu';
...
export const AWS_S3_BUCKET = process.env.hasOwnProperty('AWS_S3_BUCKET') ? process.env.AWS_S3_BUCKET : 'skin-0-care';
